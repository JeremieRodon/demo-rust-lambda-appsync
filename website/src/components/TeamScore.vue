...
<template>
  ...
  >
    ...
    <div class="grid grid-cols-1 grid-rows-3 sm:grid-cols-3 sm:grid-rows-1 grow">
      ...
      >
        <div class="text-base-content/60 font-bold sm:text-center text-sm sm:text-base">
          {{ team_display_name }}
        </div>
        <div class="flex flex-row items-center sm:justify-center">
          ...
          <div class="flex flex-row items-center gap-1 sm:flex-col sm:gap-0 sm:items-start">
