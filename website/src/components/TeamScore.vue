...
<template>
  <div
    class="flex flex-row items-center max-w-full m-2 p-1 min-w-fit rounded-box"
    :class="is_current_player_team ? 'border-2 border-secondary' : 'border'"
  >
    <team-icon :name="team.team_name" class="h-16 m-2 sm:m-4"></team-icon>
    <div class="grid grid-cols-1 grid-rows-3 sm:grid-cols-3 sm:grid-rows-1 grow">
      <div
        class="grid grid-cols-2 grid-rows-1 sm:grid-cols-1 sm:grid-rows-2 gap-2 sm:gap-0 justify-start items-center sm:px-2 sm:border-r border-dashed border-base-content/30"
      >
        <div class="text-base-content/60 font-bold sm:text-center">{{ team_display_name }}</div>
      ...
      <div
        class="grid grid-cols-2 grid-rows-1 sm:grid-cols-1 sm:grid-rows-2 justify-start items-center sm:px-2"
      >
        <div class="text-base-content/60 font-bold sm:text-center">Total Clicks</div>
        <div class="flex flex-row items-center sm:justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          ...
          <div class="flex flex-col">
            <div class="text-2xl font-black">{{ team.total_clicks }}</div>
            <div class="text-base-content/60 text-xs font-light">clicks</div>
          </div>
        </div>
      </div>
      <div
        class="grid grid-cols-2 grid-rows-1 sm:grid-cols-1 sm:grid-rows-2 justify-start items-center sm:px-2 sm:border-l border-dashed border-base-content/30"
      >
        <div class="text-base-content/60 font-bold sm:text-center">Avg. Latency</div>
        <div class="flex flex-row items-center sm:justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          ...
          <div class="flex flex-col">
            <div class="text-2xl font-black">{{ team_avg_latency_rounded }}</div>
