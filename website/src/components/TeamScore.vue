...
<template>
  ...
  >
    ...
    >
      ...
      <div
        class="text-base-content/60 font-bold text-end sm:text-center text-sm sm:text-base w-fit justify-self-end sm:border-l border-dashed border-base-content/30"
      >
        Avg. Latency
      </div>
      <div class="flex flex-row items-center sm:justify-center">
