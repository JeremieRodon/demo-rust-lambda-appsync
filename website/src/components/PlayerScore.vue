...
<template>
  ...
  >
    <div class="text-lg font-bold self-center grow text-center">#{{ rank }}</div>
    <div class="grid grid-cols-1 grid-row-2 sm:grid-cols-3 sm:grid-row-1">
      <div class="flex flex-row items-center justify-center ml-8 sm:justify-end sm:ml-0">
